    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (response.ok) {
                setIsLoading(false);
                setErrorResponse("");
                handlerSuccessLogin('Correo enviado correctamente');
                        ...
                        <div className='lg:w-11/12 max-w-[700px] px-10 py-10 absolute inset-2 lg:static rounded-3xl bg-white border-2 border-gray-100'>
                            ...
                            <form className='mt-8' onSubmit={handleSubmit}>
                                ...
                                <div className='mt-8 flex flex-col gap-y-4'>
                                    <button
                                        className='active:scale-[.98] active:duration-75 transition-all hover:scale-[1.01]  ease-in-out transform py-4 bg-violet-500 rounded-xl text-white font-bold text-lg'>Enviar enlace</button>
                                </div>
